...
class AuditLog(object):
    ...
    def copy_fields(self, model):
        ...
        """
        fields = {'__module__' : 'audit_log.models'}
    ...
    def get_meta_options(self, model):
        ...
        result = {
            ...
            'db_table': '{}_{}auditlogentry'.format(
    ...
    def create_log_entry_model(self, model):
        ...
        name = '%s%sAuditLogEntry' % (
            model._meta.app_label.title(),
            model._meta.object_name,
        )
        audit_model = type(name, (models.Model,), attrs)
        setattr(audit_log.models, name, audit_model)
        return audit_model
